...
/*
If you have problem linking with this file, do as instructed (by the mem_fn document):
...
#define LV_SHARED_NEW_MAX_PARAMS_NUM	5
#endif
...
boost::shared_ptr<T> shared_new(BOOST_PP_ENUM(n, LV_SHARED_NEW_ctor_params , ~))
{
	return boost::shared_ptr<T>(new T(BOOST_PP_ENUM_PARAMS(n, t)));
}
